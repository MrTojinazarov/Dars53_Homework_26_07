-- Databazalarni ko'rish.
SHOW DATABASES;

-- Databazani yasash.
CREATE DATABASE mysecond_db;
SHOW DATABASES;
...
INSERT INTO student (age, first_name, second_name, gender, phone_number) 
VALUES (15, 'Fotima', 'Rahimova', 'FEMALE', '+998901230000');

INSERT INTO student VALUES ('Polat', 'Alamdar', 35, 'MALE', '+99777777777');
INSERT INTO student VALUES (5, 'Temur', 'Amir', 10000, 'MALE', '+99777777776');
INSERT INTO student VALUES (5.5, 'Bobur', 'Mirzo', 500, 'MALE', '+99777777771');
...
SELECT first_name, 2024 - age AS year 
FROM student;
...
ALTER TABLE student 
ADD DateOfBirth DATE;  'yyyy-mm-dd'
...
INSERT INTO student ( first_name, second_name, age, gender, phone_number) VALUES
('Gavhar', 'Bahromova', 33, 'FEMALE', '+998924324362');